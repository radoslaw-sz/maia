...
from framework.core.message import AgentResponse, Message
from .base import BaseProvider
from framework.utils.network import wait_for_service
    ...
    def _prepare_messages(self, history: List[Message], system_message: str, ignore_trigger_prompt: str) -> List[Dict[str, str]]:
        ...
        for message in history:
            ...
            if role not in ["user", "system", "tool", "assistant"]:
                role = "assistant"
            messages_payload.append({"role": role, "content": message.content})
